...
% Method 2: slightly faster as avoids interp1
...
zvals = 0.25:(6.25-0.25)/(n-1):6.25;
Zprior = lognpdf(zvals,0.7,0.25);
...
%             Estimate MAP as median of each 1D parameter.... hmm...
            ...
            tmp_util(k) = mean(mean(bsxfun(@rdivide, abs(bsxfun(@minus, tmp_params, MAP)), tmp_params),2));
